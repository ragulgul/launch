...
class TaskResourceIT {
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION);
        // Add required entity
        Workflow workflow;
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
        // Add required entity
        Workflow workflow;
        if (TestUtil.findAll(em, Workflow.class).isEmpty()) {
    ...
    void putNewTask() throws Exception {
        ...
        updatedTask.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.name(UPDATED_NAME).description(UPDATED_DESCRIPTION);
