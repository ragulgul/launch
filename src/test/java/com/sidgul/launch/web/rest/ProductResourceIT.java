...
import com.sidgul.launch.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        ...
        if (TestUtil.findAll(em, ProductLine.class).isEmpty()) {
            productLine = ProductLineResourceIT.createEntity(em);
            em.persist(productLine);
            em.flush();
        } else {
            productLine = TestUtil.findAll(em, ProductLine.class).get(0);
        }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        ...
        ProductLine productLine;
        if (TestUtil.findAll(em, ProductLine.class).isEmpty()) {
            productLine = ProductLineResourceIT.createUpdatedEntity(em);
            em.persist(productLine);
            em.flush();
        } else {
            productLine = TestUtil.findAll(em, ProductLine.class).get(0);
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getIconContentType()).isEqualTo(DEFAULT_ICON_CONTENT_TYPE);
    }
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).icon(UPDATED_ICON).iconContentType(UPDATED_ICON_CONTENT_TYPE);
        ...
        assertThat(testProduct.getIconContentType()).isEqualTo(UPDATED_ICON_CONTENT_TYPE);
    }
