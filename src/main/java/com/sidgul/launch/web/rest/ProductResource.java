...
/**
 * REST controller for managing {@link com.sidgul.launch.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Product> partialUpdateProduct(
        ...
        Optional<Product> result = productRepository
            ...
            .map(existingProduct -> {
                ...
                if (product.getIconContentType() != null) {
                    existingProduct.setIconContentType(product.getIconContentType());
                }
