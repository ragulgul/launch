package com.sidgul.launch.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.sidgul.launch.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.sidgul.launch.repository.UserRepository.USERS_BY_EMAIL_CACHE);
